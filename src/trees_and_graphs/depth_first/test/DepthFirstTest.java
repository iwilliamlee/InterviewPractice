...
import trees_and_graphs.depth_first.DepthFirst;
...
public class DepthFirstTest {
    ...
    public void Test1() {
        ...
        LinkedList<GraphNode> path = DepthFirst.depthFirst(node1, node7);
    ...
    public void Test2() {
        ...
        node1.children = new GraphNode[]{node2, node3, node4};
        node2.children = new GraphNode[]{node1, node3};
        node3.children = new GraphNode[]{node1, node2};
        node4.children = new GraphNode[]{node1, node5};
        node5.children = new GraphNode[]{node4, node7};
        node7.children = new GraphNode[]{node5};
